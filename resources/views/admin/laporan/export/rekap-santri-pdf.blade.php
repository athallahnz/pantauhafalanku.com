...
<body>
    <section class="hero">
        <table class="hero-table">
            <tr>
                <td>
                    <h1 class="hero-title">Rekap Hafalan per Santri</h1>
                    <p class="hero-subtitle">Export PDF analitik dengan pemisahan setoran harian/tahap dan ujian akhir, plus visual capaian 30 Juz.</p>
                </td>
    ...
    <section class="section">
        ...
        <table class="summary">
            <tr>
                <td class="card-purple"><div class="label">Total Santri</div><div class="value">{{ $summary['total_santri'] ?? 0 }}</div><div class="note">Santri sesuai filter aktif.</div></td>
                <td class="card-blue"><div class="label">Setoran Harian</div><div class="value">{{ $summary['total_setoran_harian'] ?? 0 }}</div><div class="note">Harian, tahap 1, tahap 2, tahap 3.</div></td>
                <td class="card-green"><div class="label">Ujian / Juz</div><div class="value">{{ $summary['total_ujian_juz'] ?? 0 }}</div><div class="note">Jumlah Juz lulus ujian akhir.</div></td>
                <td class="card-orange"><div class="label">Rata Nilai Ujian</div><div class="value">{{ number_format((float) ($summary['avg_nilai_ujian'] ?? 0), 2) }}</div><div class="note">Hanya dari tahap ujian akhir.</div></td>
            </tr>
            <tr>
                <td><div class="label">Santri Aktif</div><div class="value">{{ $summary['santri_aktif'] ?? 0 }}</div><div class="note">Punya setoran atau ujian.</div></td>
                <td><div class="label">Santri Sudah Ujian</div><div class="value">{{ $summary['santri_sudah_ujian'] ?? 0 }}</div><div class="note">Punya minimal 1 Juz lulus ujian.</div></td>
                <td><div class="label">Nilai Sementara</div><div class="value">{{ number_format((float) ($summary['avg_nilai_sementara'] ?? 0), 2) }}</div><div class="note">Dibatasi maksimal 70.</div></td>
                <td><div class="label">Alpha</div><div class="value">{{ $summary['total_alpha'] ?? 0 }}</div><div class="note">Perlu perhatian pembinaan.</div></td>
            </tr>
        </table>
    </section>
    ...
    <section class="section page-break">
        <h2 class="section-title">Data Detail Santri</h2>
        <p class="section-copy">Kolom nilai ujian kosong jika santri belum memiliki Juz yang lulus ujian akhir.</p>
        <table class="data">
            <thead>
                <tr>
                    <th>No</th>
